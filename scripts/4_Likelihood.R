...
fm3 <- glm(Survived ~ Fare + Embarked, family = "binomial", data = titanic)
...
pois_fit <- fitdist(dat.test, distr='pois')
summary(pois_fit)
nbinom_fit <- fitdist(dat.test, distr='nbinom')
summary(nbinom_fit)
